...
```bash
git remote add encore encore://trend-analyzer-platform-8ph2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/trend-analyzer-platform-8ph2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/trend-analyzer-platform-8ph2/settings/integrations/github)
