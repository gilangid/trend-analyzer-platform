 ...
 */
export class Client {
    public readonly trends: trends.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.trends = new trends.ServiceClient(base)
    }
 ...
 */
import { history as api_trends_history_history } from "~backend/trends/history";
import { popular as api_trends_popular_popular } from "~backend/trends/popular";
import { search as api_trends_search_search } from "~backend/trends/search";
...
export namespace trends {
    ...
    export class ServiceClient {
         ...
         */
        public async history(): Promise<ResponseType<typeof api_trends_history_history>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/trends/history`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_trends_history_history>
        }

        /**
         * Retrieves the most popular trending keywords across all platforms
         */
        public async popular(): Promise<ResponseType<typeof api_trends_popular_popular>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/trends/popular`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_trends_popular_popular>
        }

        /**
         * Searches for trend data for a given keyword and platform
         */
        public async search(params: RequestType<typeof api_trends_search_search>): Promise<ResponseType<typeof api_trends_search_search>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/trends/search`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_trends_search_search>
        }
    }
}
